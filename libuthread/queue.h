 ...
 *
 * @param queue: Queue in which to enqueue item
 * @param data: Address of data item to enqueue
 ...
 * pointer) to `data`.
 *
 * @param queue: Queue in which to dequeue item
 * @param data: Address of data pointer where item is received
 ...
 * this item.
 *
 * @param queue: Queue in which to delete item
 ...
 * received as `data`.
 * 
 * @param queue: Queue to which item belongs
 ...
 * @param func: Function to call on each queue item
 ...
 *
 * @param queue: Queue to get the length of
